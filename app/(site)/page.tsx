      ...
      <section className="introduce relative">
        ...
        <div className="absolute top-[80px] md:top-[100px] left-1/2 -translate-x-1/2 w-full px-4 md:px-0 md:w-auto">
          ...
          <div className="bg-white rounded-full shadow-xl flex flex-col md:flex-row overflow-hidden">
            ...
            {/* Nhận phòng */}
            <div className="px-6 py-3 border-b md:border-b-0 md:border-r w-full md:w-40">
              <p className="text-xs font-semibold">Nhận phòng</p>
              <p className="text-sm text-gray-500">Thêm ngày</p>
            </div>

            {/* Trả phòng */}
            <div className="px-6 py-3 border-b md:border-b-0 md:border-r w-full md:w-40">
              <p className="text-xs font-semibold">Trả phòng</p>
              <p className="text-sm text-gray-500">Thêm ngày</p>
            </div>

            {/* Khách */}
            <div className="px-6 py-3 flex justify-between items-center w-full md:w-52">
              <div>
