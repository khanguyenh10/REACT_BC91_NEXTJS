    ...
    return (
        <form action={formAction}>
            <fieldset className="fieldset rounded-box w-xs  p-4">
                <h1 className='text-xl  font-bold text-center '> {action === 'ADD' ? 'Thêm' : 'Cập nhật'} Người dùng</h1>
                ...
                <div>
                    ...
                    <select className="select select-bordered" name="gender" defaultValue={data?.gender}>
                    ...
                    <div className="flex gap-6">
                        <label className="label cursor-pointer gap-2">
                            <input
                                ...
                                defaultChecked={data?.role === "ADMIN" || true}
                            />
